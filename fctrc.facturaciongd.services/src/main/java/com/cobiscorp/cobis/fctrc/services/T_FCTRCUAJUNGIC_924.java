/*
 * Archivo: T_FCTRCUAJUNGIC_924.java
 * Fecha: 2021-08-12T06:18:09Z
 *
 ...
 * T_FCTRCUAJUNGIC_924 - FormClientes 
 *
 */
@Path("/FCTRC/CLNTS/T_FCTRCUAJUNGIC_924")
@Component
@Service({T_FCTRCUAJUNGIC_924.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=FCTRC)(task.submodule=CLNTS)(task.id=T_FCTRCUAJUNGIC_924)(task.version=1.0.0))")
,@Reference(name="VW_CLIENTESDU_924", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CLIENTESDU_924)(view.version=1.0.0))")
,@Reference (name="QV_ZC59_BRX60",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_ZC59_BRX60)")
,@Reference(name="Q_CLIEETTN_GA59",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_CLIEETTN_GA59)(query.version=1.0.0))")
...
public class T_FCTRCUAJUNGIC_924 {
