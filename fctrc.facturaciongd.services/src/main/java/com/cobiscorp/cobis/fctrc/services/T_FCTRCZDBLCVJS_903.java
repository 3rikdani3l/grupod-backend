/*
 * Archivo: T_FCTRCZDBLCVJS_903.java
 * Fecha: 2021-08-13T02:51:12Z
 *
 ...
 */
package com.cobiscorp.cobis.fctrc.services;
 ...
 * T_FCTRCZDBLCVJS_903 - FormProductos 
 *
 */
@Path("/FCTRC/CLNTS/T_FCTRCZDBLCVJS_903")
@Component
@Service({T_FCTRCZDBLCVJS_903.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=FCTRC)(task.submodule=CLNTS)(task.id=T_FCTRCZDBLCVJS_903)(task.version=1.0.0))")
,@Reference(name="VW_PRODUCTOSS_213", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PRODUCTOSS_213)(view.version=1.0.0))")
,@Reference (name="QV_UG60_KCB77",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_UG60_KCB77)")
,@Reference(name="Q_PRODCTTO_RO60",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_PRODCTTO_RO60)(query.version=1.0.0))")
...
public class T_FCTRCZDBLCVJS_903 {
