...
function VC_CLIENTESQX_595924(cobisMainModule) {
    ...
    cobisMainModule.controllerProvider.register("VC_CLIENTESQX_595924_CTRL", ["cobisMessage", cobis.modules.CONTAINER + ".preferencesService", "dsgnrUtils", "designer", "$scope", "$location", "$document", "$parse", "$filter", "$modal", "$q", "$compile", "$timeout", "$translate",
    ...
    function(cobisMessage, preferencesService, dsgnrUtils, designer, $scope, $location, $document, $parse, $filter, $modal, $q, $compile, $timeout, $translate) {
        ...
        $scope.vc = designer.initViewContainer({
            ...
            "${contextPath}/resources/FCTRC/CLNTS/T_FCTRCUAJUNGIC_924",
        ...
        if (!$scope.vc.loaded) {
            ...
            $scope.vc.model.Cliente = new kendo.data.DataSource({
                transport: {
                    ...
                    create: function(options) {
                        ...
                        $scope.vc.gridRowAction('QV_ZC59_BRX60', $scope.vc.designerEventsConstants.GridRowInserting, args, function() {
                            if (!args.cancel) {
                    ...
                    update: function(options) {
                        ...
                        $scope.vc.gridRowAction('QV_ZC59_BRX60', $scope.vc.designerEventsConstants.GridRowUpdating, args, function() {
                            if (!args.cancel) {
                                options.success(args.rowData);
                            } else {
                                options.error(args.rowData);
                    ...
                    destroy: function(options) {
                        ...
                        $scope.vc.gridRowAction('QV_ZC59_BRX60', $scope.vc.designerEventsConstants.GridRowDeleting, args, function() {
                            if (!args.cancel) {
                                options.success(args.rowData);
                            } else {
            ...
            $scope.vc.grids.QV_ZC59_BRX60.AT37_CODIGOZE167 = {
                control: function(container, options) {
                    var textInput = $('<input/>', {
                        ...
                        'id': "VA_TEXTINPUTBOXWAQ_707924",
                        'data-validation-code': "{{vc.viewState.QV_ZC59_BRX60.column.codigo.validationCode}}",
            ...
            $scope.vc.grids.QV_ZC59_BRX60.AT39_CEDULAFS167 = {
                control: function(container, options) {
                    var textInput = $('<input/>', {
                        ...
                        'id': "VA_TEXTINPUTBOXQMR_571924",
                        'data-validation-code': "{{vc.viewState.QV_ZC59_BRX60.column.cedula.validationCode}}",
                        'type': "text",
                        'class': "k-textbox",
                        'ng-model-onblur': "",
            ...
            $scope.vc.grids.QV_ZC59_BRX60.AT93_NOMBREYM167 = {
                control: function(container, options) {
                    var textInput = $('<input/>', {
                        ...
                        'ng-readonly': "designer.enums.hasFlag(designer.constants.mode.Query,vc.mode)",
                        'ng-show': "designer.enums.hasFlag(designer.constants.mode.All,vc.mode)",
                        'id': "VA_TEXTINPUTBOXNRV_729924",
                        'data-validation-code': "{{vc.viewState.QV_ZC59_BRX60.column.nombre.validationCode}}",
                        'type': "text",
                        'class': "k-textbox",
                        'ng-model-onblur': "",
            ...
            $scope.vc.grids.QV_ZC59_BRX60.AT29_APELLIOD167 = {
                control: function(container, options) {
                    var textInput = $('<input/>', {
                        ...
                        'ng-readonly': "designer.enums.hasFlag(designer.constants.mode.Query,vc.mode)",
                        'ng-show': "designer.enums.hasFlag(designer.constants.mode.All,vc.mode)",
                        'id': "VA_TEXTINPUTBOXJYQ_936924",
                        'data-validation-code': "{{vc.viewState.QV_ZC59_BRX60.column.apellido.validationCode}}",
                        'type': "text",
                        'class': "k-textbox",
                        'ng-model-onblur': "",
            ...
            $scope.vc.grids.QV_ZC59_BRX60.AT93_TELEFOON167 = {
                control: function(container, options) {
                    var textInput = $('<input/>', {
                        ...
                        'ng-readonly': "designer.enums.hasFlag(designer.constants.mode.Query,vc.mode)",
                        'ng-show': "designer.enums.hasFlag(designer.constants.mode.All,vc.mode)",
                        'id': "VA_TEXTINPUTBOXAJF_968924",
                        'data-validation-code': "{{vc.viewState.QV_ZC59_BRX60.column.telefono.validationCode}}",
                        'type': "text",
                        'class': "k-textbox",
                        'ng-model-onblur': "",
            ...
            $scope.vc.grids.QV_ZC59_BRX60.AT72_DIRECCOI167 = {
                control: function(container, options) {
                    var textInput = $('<input/>', {
                        ...
                        'ng-readonly': "designer.enums.hasFlag(designer.constants.mode.Query,vc.mode)",
                        'ng-show': "designer.enums.hasFlag(designer.constants.mode.All,vc.mode)",
                        'id': "VA_TEXTINPUTBOXRRU_149924",
                        'data-validation-code': "{{vc.viewState.QV_ZC59_BRX60.column.direccion.validationCode}}",
                        'type': "text",
                        'class': "k-textbox",
                        'ng-model-onblur': "",
            ...
            if (designer.enums.hasFlag(designer.constants.mode.None, $scope.vc.mode)) {
                $scope.vc.grids.QV_ZC59_BRX60.columns.push({
                    ...
                    attributes: {
                        "class": "text-right",
                        "ng-class": "vc.viewState.QV_ZC59_BRX60.column.codigo.style",
                        "title": "{{vc.viewState.QV_ZC59_BRX60.column.codigo.tooltip|translate}}"
                    },
            ...
            if (designer.enums.hasFlag(designer.constants.mode.All, $scope.vc.mode)) {
                $scope.vc.grids.QV_ZC59_BRX60.columns.push({
                    ...
                    attributes: {
                        "class": "",
                        "ng-class": "vc.viewState.QV_ZC59_BRX60.column.cedula.style",
                        "title": "{{vc.viewState.QV_ZC59_BRX60.column.cedula.tooltip|translate}}"
                    },
            ...
            if (designer.enums.hasFlag(designer.constants.mode.All, $scope.vc.mode)) {
                $scope.vc.grids.QV_ZC59_BRX60.columns.push({
                    ...
                    attributes: {
                        "class": "",
                        "ng-class": "vc.viewState.QV_ZC59_BRX60.column.nombre.style",
                        "title": "{{vc.viewState.QV_ZC59_BRX60.column.nombre.tooltip|translate}}"
                    },
            ...
            if (designer.enums.hasFlag(designer.constants.mode.All, $scope.vc.mode)) {
                $scope.vc.grids.QV_ZC59_BRX60.columns.push({
                    ...
                    attributes: {
                        "class": "",
                        "ng-class": "vc.viewState.QV_ZC59_BRX60.column.apellido.style",
                        "title": "{{vc.viewState.QV_ZC59_BRX60.column.apellido.tooltip|translate}}"
                    },
            ...
            if (designer.enums.hasFlag(designer.constants.mode.All, $scope.vc.mode)) {
                $scope.vc.grids.QV_ZC59_BRX60.columns.push({
                    ...
                    attributes: {
                        "class": "",
                        "ng-class": "vc.viewState.QV_ZC59_BRX60.column.telefono.style",
                        "title": "{{vc.viewState.QV_ZC59_BRX60.column.telefono.tooltip|translate}}"
                    },
            ...
            if (designer.enums.hasFlag(designer.constants.mode.All, $scope.vc.mode)) {
                $scope.vc.grids.QV_ZC59_BRX60.columns.push({
                    ...
                    attributes: {
                        "class": "",
                        "ng-class": "vc.viewState.QV_ZC59_BRX60.column.direccion.style",
                        "title": "{{vc.viewState.QV_ZC59_BRX60.column.direccion.tooltip|translate}}"
                    },
            ...
            $scope.vc.grids.QV_ZC59_BRX60.columns.push({
                ...
                command: [{
                    ...
                    cssMap: "{'btn': true, 'btn-default': true, 'cb-row-image-button': true" + ", 'k-grid-edit': !vc.viewState.G_CLIENTESSS_881924.disabled}",
                    template: "<a ng-class='vc.getCssClass(\"edit\", " + "vc.viewState.QV_ZC59_BRX60.column.edit.element[dataItem.uid].style, #:cssMap#, vc.viewState.QV_ZC59_BRX60.column.edit.element[dataItem.dsgnrId].style)' " + "title=\"{{'DSGNR.SYS_DSGNR_LBLEDIT00_00005'|translate}}\" " + "ng-disabled = (vc.viewState.G_CLIENTESSS_881924.disabled==true?true:false) " + "href='\\#'>" + "<span class='fa fa-pencil'></span>" + "</a>"
                }, {
                    name: "destroy",
                    text: "{{'DSGNR.SYS_DSGNR_LBLDELETE_00008'|translate}}",
                    cssMap: "{'btn': true, 'btn-default': true, 'cb-row-image-button': true" + ", 'k-grid-delete': !vc.viewState.G_CLIENTESSS_881924.disabled}",
                    template: "<a ng-class='vc.getCssClass(\"destroy\", " + "vc.viewState.QV_ZC59_BRX60.column.delete.element[dataItem.uid].style, #:cssMap#, vc.viewState.QV_ZC59_BRX60.column.delete.element[dataItem.dsgnrId].style)' " + "title=\"{{'DSGNR.SYS_DSGNR_LBLDELETE_00008'|translate}}\" " + "ng-disabled = (vc.viewState.G_CLIENTESSS_881924.disabled==true?true:false) " + ">" + "<span class='fa fa-times'></span>" + "</a>"
                }],
                attributes: {
                    "class": "btn-toolbar"
                },
            ...
            $scope.vc.grids.QV_ZC59_BRX60.toolbar = [{
                "name": "create",
                "text": "",
                "template": "<button class = 'btn btn-default k-grid-add cb-grid-button' " + "ng-if = 'vc.viewState.QV_ZC59_BRX60.toolbar.create.visible' " + "ng-disabled = 'vc.viewState.G_CLIENTESSS_881924.disabled?true:false'" + "title = \"{{'DSGNR.SYS_DSGNR_LBLNEW000_00013'|translate}}\" >" + "<span class='fa fa-plus'></span>{{'DSGNR.SYS_DSGNR_LBLNEW000_00013'|translate}}</button>"
            }];
...
if (typeof cobisMainModule === "undefined") {
    var cobisMainModule = cobis.createModule("VC_CLIENTESQX_595924", ["ngResource", "ngRoute", "kendo.directives", "ui.bootstrap", "oc.lazyLoad", "pascalprecht.translate", cobis.modules.CONTAINER, "designerModule"], ["DSGNR", "FCTRC"]);
