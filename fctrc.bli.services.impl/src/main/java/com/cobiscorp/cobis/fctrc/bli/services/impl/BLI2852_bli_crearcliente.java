...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI2852_bli_crearcliente")
})
public class BLI2852_bli_crearcliente implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI2852_bli_crearcliente.class);
