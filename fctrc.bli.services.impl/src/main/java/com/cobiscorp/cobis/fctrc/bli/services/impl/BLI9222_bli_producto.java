...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI9222_bli_producto")
})
public class BLI9222_bli_producto implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI9222_bli_producto.class);
  ...
  public void execute(DynamicRequest dynamicRequest) {
    ...
    try {
      ...
      Character woperacion = rowProducto.get(Producto.OPERACION);
      ...
      if (logger.isDebugEnabled()) {
        logger.logDebug("inputParameters: " + " OPERACION: " + woperacion + " CODIGO: " + wcodigo + " NOMBRE: " + wnombre + " PRECIO: " + wprecio);
      }
      ...
      if (woperacion != null){
        mapper.addInputParameter("@i_operacion", SqlType.CHAR, BLIUtils.convertToType(woperacion, String.class));
      }
