...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI1148_bli_delete_producto")
})
public class BLI1148_bli_delete_producto implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI1148_bli_delete_producto.class);
