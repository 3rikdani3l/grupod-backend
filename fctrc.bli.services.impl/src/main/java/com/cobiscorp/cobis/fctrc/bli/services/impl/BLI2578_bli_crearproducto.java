...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI2578_bli_crearproducto")
})
public class BLI2578_bli_crearproducto implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI2578_bli_crearproducto.class);
