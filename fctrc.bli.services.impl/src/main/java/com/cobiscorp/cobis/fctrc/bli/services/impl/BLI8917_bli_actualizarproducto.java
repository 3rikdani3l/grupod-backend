...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI8917_bli_actualizarproducto")
})
public class BLI8917_bli_actualizarproducto implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI8917_bli_actualizarproducto.class);
