...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI1852_bli_get_productos")
})
public class BLI1852_bli_get_productos implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI1852_bli_get_productos.class);
  ...
  public void execute(DynamicRequest dynamicRequest) {
    ...
    try {
      ...
      mapperSp1.addMapper(Producto.IDPRODUCTO, 1);
      mapperSp1.addMapper(Producto.CODIGO, 2);
      mapperSp1.addMapper(Producto.NOMBRE, 3);
      mapperSp1.addMapper(Producto.PRECIO, 4);
      mapperSp1.addMapper(Producto.ESTADO, 5);
      mapperSp1.addMapper(Producto.FECHACREACION, 6, BLIUtils.getDateFormat("yyyy/MM/dd"));
