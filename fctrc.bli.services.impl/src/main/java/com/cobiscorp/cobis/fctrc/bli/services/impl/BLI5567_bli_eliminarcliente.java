...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI5567_bli_eliminarcliente")
})
public class BLI5567_bli_eliminarcliente implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI5567_bli_eliminarcliente.class);
