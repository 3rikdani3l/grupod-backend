...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI5429_bli_listarproductos")
})
public class BLI5429_bli_listarproductos implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI5429_bli_listarproductos.class);
