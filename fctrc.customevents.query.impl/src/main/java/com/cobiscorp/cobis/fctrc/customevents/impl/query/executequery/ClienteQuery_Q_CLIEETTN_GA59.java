...
public class ClienteQuery_Q_CLIEETTN_GA59 implements IExecuteQuery {
	...
	@Reference(bind = "setBLIListarCliente", unbind = "unsetBLIListarCliente", cardinality = ReferenceCardinality.MANDATORY_UNARY, target = "(bli.id=BLI9307_bli_listarclientes)")
