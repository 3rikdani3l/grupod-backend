/*
 * Archivo: T_FCTRCIMBXAZFA_448.java
 * Fecha: 2021-08-12T08:40:56Z
 *
 ...
 * T_FCTRCIMBXAZFA_448 - FormProductos 
 *
 */
@Path("/FCTRC/CLNTS/T_FCTRCIMBXAZFA_448")
@Component
@Service({T_FCTRCIMBXAZFA_448.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=FCTRC)(task.submodule=CLNTS)(task.id=T_FCTRCIMBXAZFA_448)(task.version=1.0.0))")
,@Reference(name="VW_PRODUCTOSS_586", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PRODUCTOSS_586)(view.version=1.0.0))")
,@Reference (name="QV_QS38_YVG93",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_QS38_YVG93)")
,@Reference(name="Q_PRODCOOU_UG38",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_PRODCOOU_UG38)(query.version=1.0.0))")
...
public class T_FCTRCIMBXAZFA_448 {
