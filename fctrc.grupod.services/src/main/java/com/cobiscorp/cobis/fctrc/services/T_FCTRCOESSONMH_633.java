/*
 * Archivo: T_FCTRCOESSONMH_633.java
 * Fecha: 2021-08-12T08:46:06Z
 *
 ...
 * T_FCTRCOESSONMH_633 - FormProducto 
 *
 */
@Path("/FCTRC/CLNTS/T_FCTRCOESSONMH_633")
@Component
@Service({T_FCTRCOESSONMH_633.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=FCTRC)(task.submodule=CLNTS)(task.id=T_FCTRCOESSONMH_633)(task.version=1.0.0))")
,@Reference(name="VW_PRODUCTOVG_883", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PRODUCTOVG_883)(view.version=1.0.0))")
...
public class T_FCTRCOESSONMH_633 {
