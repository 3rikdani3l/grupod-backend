...
public class ClienteQuery_QV_ZC59_BRX60 implements IGridRowDeleting {
	/**
	 * Instancia de Logger
	 */
	...
	@Reference(bind = "setBLIEliminarCliente", 
			...
			target = "(bli.id=BLI5567_bli_eliminarcliente)")
	...
	public void rowAction(DataEntity arg0, IGridRowActionEventArgs arg1) {
		...
		try {
			if (logger.isDebugEnabled()) {
				...
				logger.logDebug("Grupo D ejecutando bli eliminar cliente ...");
				
				bliEliminarCliente.execute(arg1.getDynamicRequest());
				
				logger.logDebug("Grupo D termina ejecucion bli eliminar cliente ...");
			}
		} catch (Exception ex) {
