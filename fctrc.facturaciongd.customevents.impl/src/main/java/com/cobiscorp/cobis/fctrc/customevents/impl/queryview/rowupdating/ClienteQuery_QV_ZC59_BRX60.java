...
public class ClienteQuery_QV_ZC59_BRX60 implements IGridRowUpdating {
	/**
	 * Instancia de Logger
	 */
	...
	@Reference(bind = "setBLIActualizarCliente", 
			   ...
			   target = "(bli.id=BLI3200_bli_actualizarcliente)")
	...
	public void rowAction(DataEntity arg0, IGridRowActionEventArgs arg1) {
		...
		try {
			if (logger.isDebugEnabled()) {
				...
				logger.logDebug("Grupo D ejecutando bli actualizar cliente ...");

				bliActualizarCliente.execute(arg1.getDynamicRequest());

				logger.logDebug("Grupo D termina ejecucion bli actualizar cliente ...");
			}
		} catch (Exception ex) {
